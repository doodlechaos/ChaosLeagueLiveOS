...
public class CrownShop : Game
{
    [SerializeField] private List<CrownShopEntry> _entries;
    ...
    public override void OnTilePreInit()
    {
        ...
        _entries[1].InitEntry(2, (_gt.IsGolden) ? 333_000 : 500_000);
        _entries[2].InitEntry(3, (_gt.IsGolden) ? 666_000 : 1_000_000);
